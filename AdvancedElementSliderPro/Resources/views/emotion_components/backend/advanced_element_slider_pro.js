// {namespace name="backend/emotion/sf_advanced_element_slider"}
//{block name="emotion_components/backend/vimeo_video"}
Ext.define('Shopware.apps.Emotion.view.components.AdvancedElementSliderPro', {
     ...
     */
    alias: 'widget.advanced-element-slider-pro'
